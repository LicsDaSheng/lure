//! `ensureWorkspace` 创建的 agent workspace 默认模板（对齐 agent/workspace_templates.rs）。
...
export const DEFAULT_AGENTS = `# Agent Instructions
...
export const DEFAULT_HEARTBEAT = `# Heartbeat Tasks
