...
#[tokio::test]
async fn echo_model_returns_offline_echo_provider() {
...
#[tokio::test]
async fn preset_and_model_are_mutually_exclusive() {
...
#[tokio::test]
async fn default_config_with_api_key_returns_real_provider() {
