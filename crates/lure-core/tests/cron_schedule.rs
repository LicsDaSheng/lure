...
#[tokio::test]
async fn every_15_minutes_returns_next_quarter() {
...
#[tokio::test]
async fn daily_at_nine_returns_same_day_nine() {
    assert_eq!(
...
#[tokio::test]
async fn daily_midnight_strictly_after_now_is_next_day() {
    assert_eq!(
...
#[tokio::test]
async fn weekday_monday_from_thursday() {
...
#[tokio::test]
async fn dow_seven_is_sunday_same_as_zero() {
...
#[tokio::test]
async fn dom_and_dow_both_restricted_is_or() {
...
#[tokio::test]
async fn range_and_list_fields() {
...
#[tokio::test]
async fn yearly_feb_29_within_four_years() {
...
#[tokio::test]
async fn invalid_expr_returns_none() {
...
#[tokio::test]
async fn named_timezone_shanghai_offset_plus_eight() {
...
#[tokio::test]
async fn named_timezone_new_york_winter_is_est() {
...
#[tokio::test]
async fn named_timezone_skips_dst_spring_forward_gap() {
...
#[tokio::test]
async fn invalid_timezone_name_returns_none() {
...
#[tokio::test]
async fn none_timezone_local_returns_some_for_valid_expr() {
