...
#[tokio::test]
async fn strip_think_removes_well_formed_block() {
    assert_eq!(
...
#[tokio::test]
async fn strip_think_drops_pure_leak_to_empty() {
...
#[tokio::test]
async fn strip_think_keeps_ordinary_text() {
    assert_eq!(
...
#[tokio::test]
async fn context_injects_memory_between_system_and_history() {
...
#[tokio::test]
async fn context_skips_empty_memory() {
